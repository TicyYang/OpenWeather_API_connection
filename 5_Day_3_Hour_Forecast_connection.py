...
'''
The parameters 'lat' and 'lng' should correspond to the location coordinates you want to obtain weather information.
...
url = f'https://api.openweathermap.org/data/2.5/forecast?lat={lat}&lon={lng}&appid={key}&units={units}&timezone={timezone}'
